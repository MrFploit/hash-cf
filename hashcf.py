...
\033[94m
 ...
 |_|  |_|\__,_|___/_| |_|  \_____(_)_|
    ...
    Do you want to find the hash type or crack it?
    [1]Crack
    [2]Find
...
def Hcrack():
 ...
 |_|  |_|\__,_|___/_| |_|  \_____|_|  \__,_|\___|_|\_\___|_|
    ...
    What type of hash do you want to crack?
    [1]MD5
    [2]SHA-1
    [3]SHA-224
    [4]SHA-256
    ...
    [7]Back
    ''')
    hashType = input("Please enter the hash number>>> ")
    if hashType=='1':
        os.system("clear")
        md5()
    elif hashType=='2':
        ...
        os.system("clear")
        os.system("python3 hashcracker.py")
...
def Hfinder():
 ...
 |_|  |_|\__,_|___/_| |_| |_|    |_|_| |_|\__,_|\___|_|
    ...
    #     import hashid
    # except:
    #     print("The hashid library is being installed...")
    #     time.sleep(3)
    #     os.system("pip3 install hashid")
    #
    # fhash = input("Please enter your hash>>> ")
...
def md5():
 ...
 |_|  |_|_____/|____/
    ...
    '''
    print(bmd5)
    wlist= input("Enter the Word List>>> ")
    hash= input("Enter the hash>> ")
    wlistlines=open(wlist, 'r').readlines()
    for i in range(0, len(wlistlines)):
        hashc=hashlib.md5(wlistlines[i].replace("\n","").encode()).hexdigest()
        if hash==hashc:
            print("\033[92mpassword found: "+wlistlines[i].replace("\n",""))
            sys.exit()
        else:
            print("\033[91mpassword not found")
def sha1():
    bsha1='''
   _____ _    _              __
  / ____| |  | |   /\       /_ |
 ...
 |_____/|_|  |_/_/    \_\    |_|
    ...
    wlistlines=open(wlist, 'r').readlines()
    for i in range(0, len(wlistlines)):
        hashc=hashlib.sha1(wlistlines[i].replace("\n","").encode()).hexdigest()
        if hash==hashc:
            print("\033[92mpassword found: "+wlistlines[i].replace("\n",""))
            sys.exit()
        else:
...
def sha224():
 ...
 |_____/|_|  |_/_/    \_\  |____|____|  |_|
    ...
    wlistlines=open(wlist, 'r').readlines()
    for i in range(0, len(wlistlines)):
        hashc=hashlib.sha224(wlistlines[i].replace("\n","").encode()).hexdigest()
        if hash==hashc:
            print("\033[92mpassword found: "+wlistlines[i].replace("\n",""))
            sys.exit()
        else:
...
def sha256():
 ...
 |_____/|_|  |_/_/    \_\  |____|____/ \___/
    ...
    wlistlines=open(wlist, 'r').readlines()
    for i in range(0, len(wlistlines)):
        hashc=hashlib.sha256(wlistlines[i].replace("\n","").encode()).hexdigest()
        if hash==hashc:
            print("\033[92mpassword found: "+wlistlines[i].replace("\n",""))
            sys.exit()
        else:
...
def sha384():
 ...
 |_____/|_|  |_/_/    \_\   |____/ \___/   |_|
    ...
    wlistlines=open(wlist, 'r').readlines()
    for i in range(0, len(wlistlines)):
        hashc=hashlib.sha384(wlistlines[i].replace("\n","").encode()).hexdigest()
        if hash==hashc:
            print("\033[92mpassword found: "+wlistlines[i].replace("\n",""))
            sys.exit()
        else:
...
def sha512():
 ...
 |_____/|_|  |_/_/    \_\    |____/ |_|____|
    ...
    wlistlines=open(wlist, 'r').readlines()
    for i in range(0, len(wlistlines)):
        hashc=hashlib.sha512(wlistlines[i].replace("\n","").encode()).hexdigest()
        if hash==hashc:
            print("\033[92mpassword found: "+wlistlines[i].replace("\n",""))
            sys.exit()
        else:
...
def main():
    print(b)
    which=input("Please select the option you want>>> ")
    if which=='1':
        os.system("clear")
        Hcrack()
    elif which=='2':
